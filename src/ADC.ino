...
void BAT_ADC_Sampling() //电池电压采样
{
  ...
  if (bat_voltage < 4.5 && bat_voltage >= 4.1)
    p1 = F16x16_b100;
  else if (bat_voltage < 4.1 && bat_voltage >= 3.8)
    p1 = F16x16_b80;
  else if (bat_voltage < 3.8 && bat_voltage >= 3.7)
    p1 = F16x16_b40;
  else if (bat_voltage < 3.7 && bat_voltage >= 3.6)
    p1 = F16x16_b20;
  else if (bat_voltage < 3.6 && bat_voltage >= 3.3)
    p1 = F16x16_b0;
